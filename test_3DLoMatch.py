...
def eval_3DLoMatch(config):
    ...
    allpair_status_RE_txt = os.path.join(".", "allpair_status_Suceess.txt")
    np.savetxt(allpair_status_RE_txt, allpair_status_ndarray[:, 0], fmt="%d")

    allpair_status_RE_txt = os.path.join(".", "allpair_status_RE.txt")
    np.savetxt(allpair_status_RE_txt, allpair_status_ndarray[:, 1], fmt="%.4f")

    allpair_status_TE_txt = os.path.join(".", "allpair_status_TE.txt")
    np.savetxt(allpair_status_TE_txt, allpair_status_ndarray[:, 2], fmt="%.4f")

    allpair_status_Inlier_Ratio_txt = os.path.join(".", "allpair_status_Inlier_Ratio.txt")
    np.savetxt(allpair_status_Inlier_Ratio_txt, allpair_status_ndarray[:, 4], fmt="%.4f")

    allpair_status_Precision_txt = os.path.join(".", "allpair_status_Precision.txt")
    np.savetxt(allpair_status_Precision_txt, allpair_status_ndarray[:, 6], fmt="%.4f")

    allpair_status_Recall_txt = os.path.join(".", "allpair_status_Recall.txt")
    np.savetxt(allpair_status_Recall_txt, allpair_status_ndarray[:, 7], fmt="%.4f")

    allpair_status_F1_txt = os.path.join(".", "allpair_status_F1.txt")
    np.savetxt(allpair_status_F1_txt, allpair_status_ndarray[:, 8], fmt="%.4f")
    ...
    print("NS_by_IC:", config.NS_by_IC)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_npy', default=True, type=str2bool)
